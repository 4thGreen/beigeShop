		...
		<div>
			<table class="table"> 
				<tr align="center">
					...
					<td width="90px">공개여부</td>
				</tr>
			    <%
				for (int i = 0; i < boards.size(); i++) {
					BoardDTO board = boards.get(i);
					boolean isMine = false;
					if (board.getB_ref() != board.getB_id() && userID != null) {
					...
					if (isNotice) {
						out.print("<tr style=\"background-color: rgb(227, 227, 227); cursor:pointer;\" "
							+ "onmouseover=\"this.style.backgroundColor='#d6d6d6'\" onmouseout=\"this.style.backgroundColor='#e3e3e3'\" align=\"center\""
							+ "onClick=\"location.href='boardView.jsp?b_id="+board.getB_id()+"'\" >");
					} else if (isMine) {
						out.print("<tr class='table-info' style=\"background-color: rgb(227, 227, 227); cursor:pointer;\" "
								+ "onmouseover=\"this.style.backgroundColor='#d6d6d6'\" onmouseout=\"this.style.backgroundColor='#e3e3e3'\" align=\"center\""
								+ "onClick=\"location.href='boardView.jsp?b_id="+board.getB_id()+"'\" >");
					} else {
					...
					out.print("<td align='left'>" + board.getB_title() + "</td>");
...
<div class="footer" id="footer" align="center">
	<footer>
C		OPYRIGHT © 2021 BEIGESHOP. 박민선, 박민정, 박성욱, 박지은, 이호승, 조수민.
	</footer>
</div>
</body>
</html>