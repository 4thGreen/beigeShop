...
//			stmt = conn.createStatement();
			...
			if(rs.next()) {
				...
				while(count < ProductDB.pageSize) {
					...
					product.setS_image2(rs.getString(8));
	...
	public ArrayList<ProductDB> getSearch(String searchProduct){
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs=null;
		ProductDB product = null;
		...
		String sql = "select * from beige_shop where s_name='"+searchProduct+"'";
		try {
