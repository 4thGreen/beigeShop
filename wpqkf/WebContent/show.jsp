			...
			<table border="1" width="800" cellspacing = "0" >
				...
				<tr height="30">
					<td colspan="4" align="right">
						<input type="button" value="상품수정" onclick="location.href='edit.jsp?s_id=<%=s_id%>&pageNum=<%=pageNum%>'">
						<input type="button" value="상품삭제" onclick="location.href='delete.jsp?s_id=<%=s_id %>&pageNum=<%=pageNum%>'"> 
